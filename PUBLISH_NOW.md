...
```bash
git tag -a v0.7.0 -m "Octolearn v0.7.0 - Initial Release"
...
```
Tag version: v0.7.0
Release title: Octolearn v0.7.0 - Initial Release
...
ls dist/
# Should show:
# octolearn-0.7.0-py3-none-any.whl
# octolearn-0.7.0.tar.gz
```
