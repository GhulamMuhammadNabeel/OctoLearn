...
```bash
git tag -a v0.5.3 -m "Octolearn v0.5.3 - Initial Release"
...
```
Tag version: v0.5.3
Release title: Octolearn v0.5.3 - Initial Release
...
ls dist/
# Should show:
# octolearn-0.5.3-py3-none-any.whl
# octolearn-0.5.3.tar.gz
```
